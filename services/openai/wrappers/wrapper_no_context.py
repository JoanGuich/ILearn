...
class OpenAIFunctionNoContext:
    ...
    def get_function_inputs(self, text: str) -> dict[str, Any] | None:
        # if text == "" or context == "":
        if text == "":
            return None
        ...
        response = openai.chat.completions.create(
            ...
            messages=[
                ...
                # {"role": "assistant", "content": self.assistant_template.format(context),},
    ...
    # async def aget_function_inputs(self, context: str, text: str) -> dict[str, Any] | None:
    async def aget_function_inputs(self, text: str) -> dict[str, Any] | None:
    ...
    def predict_on_text(self, text: str) -> list[dict[str, Any]]:
        # res = self.get_function_inputs(context, text)
        res = self.get_function_inputs(text)
        if res is None:
            return []
        return [res]

    # async def async_predict_on_text(self, context: str, text: str) -> list[dict[str, Any]]:
    async def async_predict_on_text(self, text: str) -> list[dict[str, Any]]:
